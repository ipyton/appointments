    ...
    <div className="min-h-screen flex flex-col">
        ...
        <div className="container mx-auto px-6 py-16 md:py-24 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-16 md:mb-0 md:pr-10">
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              <Link 
                ...
                className="px-8 py-3 bg-white text-blue-700 rounded-lg font-medium text-center hover:bg-blue-50 transition-colors"
              >
                Book an Appointment
              </Link>
              <Link 
                href="/register?role=provider"
                className="px-8 py-3 border border-white text-white rounded-lg font-medium text-center hover:bg-white/10 transition-colors"
              >
                Offer Your Services
              </Link>
            </div>
          ...
          <div className="md:w-1/2 flex justify-center md:justify-end">
            <div className="relative w-full max-w-md h-72 md:h-96">
              <div className="absolute top-0 right-0 bg-white/10 rounded-lg w-full h-full transform rotate-3 backdrop-blur-sm"></div>
              <div className="absolute top-0 right-0 bg-indigo-600/20 rounded-lg w-full h-full transform -rotate-3 backdrop-blur-sm"></div>
                ...
                <div className="text-gray-800">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center">
                      ...
                      <span>123 Main Street, Suite 4B</span>
                    </div>
                    <div className="flex items-center">
                      <svg className="w-5 h-5 text-blue-600 mr-2" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold text-center mb-16">How AppointEase Works</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-semibold mb-4">Book or Manage</h3>
              <p className="text-gray-600">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-semibold mb-4">Enjoy Hassle-Free Scheduling</h3>
              <p className="text-gray-600">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold text-center mb-16">Who Uses AppointEase?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="bg-blue-50 rounded-xl p-8 flex flex-col h-full shadow-sm">
              ...
              <ul className="space-y-3 mb-8 flex-grow">
                <li className="flex items-start">
                  ...
                  <span>Easy appointment booking with preferred service providers</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-blue-600 mr-2 mt-1" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span>Automated reminders to prevent missed appointments</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-blue-600 mr-2 mt-1" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span>View your complete appointment history in one place</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-blue-600 mr-2 mt-1" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span>Easily reschedule or cancel when needed</span>
                </li>
              </ul>
              <Link 
                href="/register?role=user"
                className="px-6 py-3 bg-blue-600 text-white rounded-lg font-medium text-center hover:bg-blue-700 transition-colors w-full"
              >
            ...
            <div className="bg-green-50 rounded-xl p-8 flex flex-col h-full shadow-sm">
              <div className="mb-6">
                ...
                <h3 className="text-2xl font-semibold mb-4">For Service Providers</h3>
              </div>
              <ul className="space-y-3 mb-8 flex-grow">
                <li className="flex items-start">
                  ...
                  <span>Comprehensive calendar management system</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-green-600 mr-2 mt-1" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span>Reduced no-shows with automated client reminders</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-green-600 mr-2 mt-1" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span>Manage multiple services and time slots effortlessly</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-green-600 mr-2 mt-1" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
              ...
              <Link 
                href="/register?role=provider"
                className="px-6 py-3 bg-green-600 text-white rounded-lg font-medium text-center hover:bg-green-700 transition-colors w-full"
              >
      ...
      <section className="py-16 bg-blue-600 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            <Link 
              href="/register"
              className="px-8 py-3 bg-white text-blue-700 rounded-lg font-medium hover:bg-blue-50 transition-colors"
            >
